            ...
            <nav className="bg-gray-900 border-gray-200">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <Link href="https://seanm.tech/" className="flex items-center">
                        <Image src="/Icon.png" className="h-8 mr-3" alt="Logo" width={32} height={32}/>
                    ...
                    <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                        <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-700 rounded-lg bg-gray-800 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-gray-900">
                            ...
                            <li>
                                <Link href="/construction" className="block py-2 pl-3 pr-4 text-text-white rounded hover:bg-gray-700 md:border-0 md:hover:text-purple-500 md:p-0 md:hover:bg-transparent">About</Link>
                            </li>
                            <li>
                                <Link href="/construction" className="block py-2 pl-3 pr-4 text-text-white rounded hover:bg-gray-700 md:border-0 md:hover:text-purple-500 md:p-0 md:hover:bg-transparent">Contact</Link>
                            </li>
                        </ul>
                    </div>
                </div>
