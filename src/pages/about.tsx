...
const About: NextPageWithLayout = () => {
  return (
    <div className="max-w-screen-xl flex flex-col p-4 h-full mx-auto w-full">
      <div id='pitch' className='flex'>
        <figure className='h-full basis-1/5 mr-4'>
          <Image src={onAHill} className='object-cover rounded-3xl shadow-2xl shadow-theme-1 h-full' alt='More Pictures of Sean' />
        </figure>
        <div className='basis-4/5'>
          <p className='text-4xl mb-4'>Meet Sean.</p>
