    ...
    <div className="max-w-screen-xl flex flex-col p-4 h-full mx-auto w-full mt-16 md:mt-32">
      ...
      <div className="md:text-xl sm:w-3/4 md:w-4/5 lg:w-1/2 border-x border-white/30 sm:mx-auto">
        <div className="flex justify-between items-center gap-4 w-4/5 mx-auto py-4 text-xl sm:text-2xl md:text-3xl text-white/70">
          <a className='hover:text-purple-400' href='https://www.linkedin.com/in/smorrison26/' target='_blank' aria-label='LinkedIn profile'>
            <FontAwesomeIcon icon={faLinkedin} />
          </a>
          <a className='hover:text-purple-400' href='https://github.com/sMorrison26/' target='_blank' aria-label='GitHub profile'>
            <FontAwesomeIcon icon={faGithub} />
          </a>
          <a className='hover:text-purple-400' href='mailto:morrisonsean123@gmail.com' target='_blank' aria-label='Email'>
