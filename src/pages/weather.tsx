...
function Weather() {
    ...
    function conditionalBackground(data) {
        ...
        if (headElement) {
            element.style.background = "linear-gradient(rgb(120, 120, 194,0.5)," + color;
        }
    }
    return (
        // <>
            <div className="flex justify-center items-center h-full mt-24 text-text-white">
                <div className="p-4 box bg-gradient-to-t from-transparent via-[rgb(33,103,208)] to-[rgb(0,208,255)] rounded-lg border-3 
